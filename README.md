# Supervised Learning : Predicting probable donors for a fictitious charity organization
...
We need to have software installed to run and execute an [iPython Notebook](http://ipython.org/notebook.html)
